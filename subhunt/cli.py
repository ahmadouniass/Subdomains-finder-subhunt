#!/usr/bin/env python3
"""
subhunt/cli.py — Installable CLI entry point for subhunt.

This module lives inside the ``subhunt`` package so that the console_scripts
entry point defined in setup.py can resolve it after ``pip install``.
